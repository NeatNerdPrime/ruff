...
impl<'db> ConstraintSet<'db> {
    ...
    pub(crate) fn display(&self, db: &'db dyn Db) -> impl Display {
        ...
        impl<'db> Display for DisplayConstraintSet<'_, 'db> {
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                if self.set.clauses.len() == 0 {
...
impl<'db> ConstraintClause<'db> {
    ...
    fn display(&self, db: &'db dyn Db) -> impl Display {
        ...
        impl<'db> Display for DisplayConstraintClause<'_, 'db> {
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                if self.clause.constraints.len() == 0 {
...
impl<'db> AtomicConstraint<'db> {
    ...
    fn display(self, db: &'db dyn Db) -> impl Display {
        ...
        impl<'db> Display for DisplayAtomicConstraint<'db> {
            fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
